...
public class RationalPolynomialTest {
    ...
    public void divideRationalPolynomialTest() {
        ...
        RationalPolynomial p8 = new RationalPolynomial(new RationalNumber[] {
            new RationalNumber(4, 1),
                new RationalNumber(4, 1)});
        RationalPolynomial p9 = new RationalPolynomial(new RationalNumber[] {
                new RationalNumber(1, 1),
                new RationalNumber(1, 1)});
        assertEquals(p8.divide(p9)[0], new RationalPolynomial(new RationalNumber[]{new RationalNumber(4,1)}));
        assertEquals(p8.divide(p9)[1], RationalPolynomial.ZERO);

        RationalPolynomial p10 = new RationalPolynomial(new RationalNumber[] {
                ...
                new RationalNumber(1, 1),
                RationalNumber.ZERO});
        RationalPolynomial p11 = new RationalPolynomial(new RationalNumber[] {
                new RationalNumber(4, 1),
                new RationalNumber(0, 1),
                new RationalNumber(0, 1),
                new RationalNumber(1, 1)});
        RationalPolynomial p12 = new RationalPolynomial(new RationalNumber[] {
                new RationalNumber(0, 1),
                new RationalNumber(1, 1),
                new RationalNumber(1, 1)});
        RationalPolynomial p13 = new RationalPolynomial(new RationalNumber[] {
                new RationalNumber(9, 1)});
        ...
        RationalPolynomial p14 = new RationalPolynomial(new RationalNumber[] {
                new RationalNumber(1, 1),
                new RationalNumber(1, 1)});
        RationalPolynomial p15 = new RationalPolynomial(new RationalNumber[] {
                new RationalNumber(2, 1),
                RationalNumber.ZERO,
                new RationalNumber(1, 1)});
